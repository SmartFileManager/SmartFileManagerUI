 ...
 * @author user
 */
public class CollapsiblePanelBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_title] = new PropertyDescriptor ( "title", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getTitle", "setTitle" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_add2] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("add", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_add2].setDisplayName ( "" );
            methods[METHOD_add3] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("add", new Class[] {java.lang.String.class, java.awt.Component.class})); // NOI18N
            methods[METHOD_add3].setDisplayName ( "" );
            methods[METHOD_add4] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("add", new Class[] {java.awt.Component.class, int.class})); // NOI18N
            methods[METHOD_add4].setDisplayName ( "" );
            methods[METHOD_add5] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("add", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_add5].setDisplayName ( "" );
            methods[METHOD_add6] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("add", new Class[] {java.awt.Component.class, java.lang.Object.class, int.class})); // NOI18N
            ...
            methods[METHOD_remove108] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("remove", new Class[] {int.class})); // NOI18N
            methods[METHOD_remove108].setDisplayName ( "" );
            methods[METHOD_remove109] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("remove", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_remove109].setDisplayName ( "" );
            methods[METHOD_removeAll110] = new MethodDescriptor(gr.teicm.pm.smartfilemanager.smartfilemanagerui.collapsiblepane.CollapsiblePanel.class.getMethod("removeAll", new Class[] {})); // NOI18N
